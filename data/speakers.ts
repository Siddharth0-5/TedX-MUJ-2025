...
export const speakers: Speaker[] = [
  ...
  },
  {
    name: "Rishab Chadha",
    topic: "Actor",
    bio: "Rishab Chadha is a versatile performer celebrated for his dynamic screen presence across film, television and digital platforms. A true 90s kid, he brings nostalgia and modern charm together through roles in Drishyam, Khoobsurat and beloved Disney Channel shows like The Suite Life of Karan & Kabir and Best of Luck Nikki. Having appeared in over 150 commercials and most recently acclaimed for his performance in Zee5’s Divorce Ke Liye Kuch Bhi Karega, Rishabh continues to redefine storytelling through authenticity and emotion. In tune with our theme “ Parallax,” he reminds us that every frame holds a new perspective and that stories change when we dare to see them differently.",
    image:"/rishab.jpeg",
    instagram: "https://www.instagram.com/rishabchadhaofficial?igsh=eHZ0cWxjcjU0bmlz",
    featured: true,
  },
  {
    name: "Prachi Tehlan",
    topic: "Actor",
    bio: "From leading India on the court to captivating millions on screen, Prachi Tehlan is the embodiment of determination and transformation. A former captain of the Indian Netball Team, she led her team to win India’s first-ever international medal at the 2011 South Asian Beach Games and proudly represented the country at the Commonwealth Games and the Youth Asian Championship. Her journey from athlete to acclaimed actress reflects the power of perseverance, adaptability, and fearless ambition. At TEDx, Prachi stands as a symbol of what it means to reinvent yourself: to lead, to evolve, and to keep breaking barriers with every new chapter.",
    image: "/prachi.jpeg",
    instagram: "https://www.instagram.com/prachitehlan?igsh=MjJ3aG1icW5qMXBi",
    featured: true,
  },
];